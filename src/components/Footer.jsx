        ...
        <footer className="grid container bg-secondary px-4 py-6 gap-6">
            <div className="grid gap-3">
                <div className="flex gap-3 items-center">
                    ...
                    <h2 className="text-third font-tungsten text-3xl tracking-wider">ARUM</h2>
                </div>
            ...
            <div className="text-third">
                ...
                <ul className="font-din text-fourth flex gap-3">
                    <li><a href="https://www.instagram.com/pplgtwooo_/" target="_blank"><img src={instagram} alt="" /></a></li>
                    <li><a href="https://www.youtube.com/@pplgtwoofus9054" target="_blank"><img src={youtube} alt="" /></a></li>
                </ul>
            </div>
